...
* `Implicit_Task_Data_Experiment1.rtf`: Original preprocessing instructions and data description document provided by Aitana Grasso-Cladera.
...
Most participants completed 96 trials in total.

A subset of participants completed 80 trials, which were handled separately during restructuring.
